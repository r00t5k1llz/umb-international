...
<div class="mainContainer">
    ...
    <div class="contentContainer">
        ...
        <div class="right">
            <h3 style="border-bottom: 1px solid #68a54b;width: 500px">Enter Transfer Bond Code to continue with transfer...</h3>
            <p>Please provide a Transfer Bond Code given to you by the Bank to continue with your transfer. Please contact your bank if you do not have it.</p>
            <?php
				...
				echo "<div class=\"alert alert-danger\">";
				echo 'Please enter a EU Transfer Code';
				echo "</div>";	
				}
				}

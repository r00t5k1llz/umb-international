...
<div class="mainContainer">
    ...
    <div class="contentContainer">
        ...
        <div class="right">
            <h3 style="border-bottom: 1px solid #68a54b;width: 500px">SETTINGS</h3>
            <p>Make Changes to your Account For your own security</p>
            <div>
                <h4>Change Nickname</h4>
                <div><a href="change_nickname.php">Change Account Nickname</a> </div>
            </div>
            <div>
                <h4>Chane Email Address</h4>
                <div><a href="change_email.php">Change Email Address</a> </div>
            </div>
            <div>
